...
with seed_variants (
  ...
  values
  ('jackets', 'ANAI-JACKETS-BLACK-OS', 'Black', '#111111', 2200, 2),
  ('jackets', 'ANAI-JACKETS-BROWN-OS', 'Brown', '#6f4631', 2200, 2),
  ('jackets', 'ANAI-JACKETS-NAVY-OS', 'Navy', '#253b54', 2200, 3),
  ('long-sleeve-round-neck', 'ANAI-LSRN-BLACK-OS', 'Black', '#111111', 1990, 1),
  ('long-sleeve-round-neck', 'ANAI-LSRN-BROWN-OS', 'Brown', '#6f4631', 1990, 1),
  ('long-sleeve-round-neck', 'ANAI-LSRN-WHITE-OS', 'White', '#f6f1ea', 1990, 1),
  ('long-sleeve-swirl-neck', 'ANAI-LSSN-BLACK-OS', 'Black', '#111111', 1990, 2),
  ('long-sleeve-swirl-neck', 'ANAI-LSSN-BROWN-OS', 'Brown', '#6f4631', 1990, 0),
  ('long-sleeve-swirl-neck', 'ANAI-LSSN-CREAM-OS', 'Cream', '#efe7dc', 1990, 1),
  ('minit-t-shirt', 'ANAI-MINIT-BLACK-OS', 'Black', '#111111', 1500, 1),
  ('sahara-corsage-set', 'ANAI-SAHARA-BLACK-OS', 'Black', '#111111', 4490, 1),
  ('sahara-corsage-set', 'ANAI-SAHARA-GREY-OS', 'Grey', '#d7d4c9', 4490, 1),
  ('sahara-corsage-set', 'ANAI-SAHARA-NAVY-OS', 'Navy blue', '#253b54', 4490, 1),
  ('lela-set', 'ANAI-LELA-BLACK-OS', 'Black', '#111111', 4990, 0),
  ('lela-set', 'ANAI-LELA-BROWN-OS', 'Brown', '#6f4631', 4990, 3),
  ('lela-set', 'ANAI-LELA-WHITE-OS', 'White', '#f6f1ea', 4990, 0),
  ('mvua-flannel', 'ANAI-MVUA-BLACK-OS', 'Black', '#111111', 3290, 3),
  ('mvua-flannel', 'ANAI-MVUA-BROWN-OS', 'Brown', '#6f4631', 3290, 0),
  ('mvua-flannel', 'ANAI-MVUA-CREAM-OS', 'Cream', '#efe7dc', 3290, 0),
  ('strappy-bra', 'ANAI-BRA-BLACK-OS', 'Black', '#111111', 1499, 1),
  ('strappy-bra', 'ANAI-BRA-BROWN-OS', 'Brown', '#6f4631', 1499, 1),
  ('strappy-bra', 'ANAI-BRA-WHITE-OS', 'White', '#f6f1ea', 1499, 1),
  ('terra-skirt', 'ANAI-TERRA-BLACK-OS', 'Black', '#111111', 2490, 1),
  ('terra-skirt', 'ANAI-TERRA-BURGUNDY-OS', 'Burgundy', '#4a2428', 2490, 1),
  ('terra-skirt', 'ANAI-TERRA-GREEN-OS', 'Green', '#4a5134', 2490, 0),
  ('nuru-short-set', 'ANAI-NURU-BLACK-OS', 'Black', '#111111', 4490, 1),
  ('nuru-short-set', 'ANAI-NURU-GREY-OS', 'Grey', '#c9cbc6', 4490, 1),
  ('nuru-short-set', 'ANAI-NURU-NAVY-OS', 'Navy blue', '#253b54', 4490, 1),
  ('mia-cropped-tee', 'ANAI-MIA-BLACK-OS', 'Black', '#111111', 1600, 2),
  ('mia-cropped-tee', 'ANAI-MIA-BURGUNDY-OS', 'Burgundy', '#4a2428', 1600, 2),
  ('mia-cropped-tee', 'ANAI-MIA-WHITE-OS', 'White', '#f6f1ea', 1600, 2)
)
