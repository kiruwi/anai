...
export const categoryTiles: ImageTile[] = [
  {
    title: 'Sets',
    href: '/sets',
    imageUrl: 'https://images.unsplash.com/photo-1518459031867-a89b944bffe4?auto=format&fit=crop&w=900&q=80',
    imageTone: 'linear-gradient(135deg, #461828, #c66747)',
  },
  {
    title: 'Tops',
